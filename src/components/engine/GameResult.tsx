  ...
  return (
    <div className="w-full max-w-2xl mx-auto flex flex-col items-center">
      <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 w-full text-center">
        ...
        <h2 className="text-4xl font-bold text-primary-teal mb-2">Activity Complete</h2>
        ...
        <div className="grid grid-cols-2 gap-6 mb-10 text-left">
          ...
          <div className="bg-gray-50 p-6 rounded-2xl flex items-center space-x-4 border border-gray-100">
            ...
            <div>
              <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">Accuracy</p>
          ...
          <div className="bg-gray-50 p-6 rounded-2xl flex items-center space-x-4 border border-gray-100">
            ...
            <div>
              <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">Mistakes</p>
